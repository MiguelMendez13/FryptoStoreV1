...
licuadoraImagen=["Licuadora1.jpg","Licuadora2.jpg","Licuadora3.jpg","Licuadora4.jpg","Licuadora5.jpg","Licuadora6.jpg","Licuadora7.jpg","Licuadora8.jpg"]
...
Descripcion="Esta licuadora de la marca %s cuenta con %s motores, fabricada en %s además de contar con %s velocidades incluyendo un botón extra para moler hielo en tan solo %s segundos, Contiene una potencia de %s watts, con un peso de %s kg y fabricación exterior de %s."
marcas=["Mabe","Oster","RCA","LG","Hisense"]
materiales=["Platico","Aluminio","Metal"]


archivo=open("lista de Registros.txt","w")
...
def genfun(marcaE):
	...
	peso="{0:.2f}".format(random.randint(0,3)+random.random())
...
for x2 in range(0,30):
	...
	copiarimagen=shutil.copy("LicuadorasPlantilla/"+imagensel, codigo+".jpg")
