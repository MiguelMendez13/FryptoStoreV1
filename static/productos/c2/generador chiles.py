...
licuadoraImagen=["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg"]
...
Descripcion="Chile de nuestros mejores provedores del estado de %s, con una calidad de %s estrellas de %s kg"
marcas=["Pasilla","Guajillo","Piquin","Habanero","Arbol"]



archivo=open("lista de Registros Chile.txt","w")
...
for x2 in range(75,90):
	...
	copiarimagen=shutil.copy("Plantillas/chiles/"+imagensel, codigo+".jpg")
