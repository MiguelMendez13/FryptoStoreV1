...
licuadoraImagen=["1.jpg","2.jpg","3.jpg","4.jpg"]
...
Descripcion="Frijol de nuestros mejores provedores del estado de %s, con una calidad de %s estrellas de %s kg"
marcas=["Negro","Peruano","Ballo"]



archivo=open("lista de Registros Frijoles.txt","w")
...
for x2 in range(90,105):
	...
	copiarimagen=shutil.copy("Plantillas/frijoles/"+imagensel, codigo+".jpg")
